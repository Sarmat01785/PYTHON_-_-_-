...
#
# Модуль `pathlib` представляет файловую систему в виде объектов, что упрощает процесс обработки путей и файлов.
# В этом примере мы используем `Path` из `pathlib` для поиска недавно измененных файлов и файлов
