...
# Важно отметить, что filter возвращает генератор, который можно преобразовать в список, если это необходимо
...
# там, где функциональность требуется однократно или в небольшом объеме кода. Они также могут быть использованы
# для создания анонимных функций, которые не требуют именования, что может быть полезно в некоторых случаях.
